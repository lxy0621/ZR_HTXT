// 获取代记账订单列表
export function pagingAgentOrders(param) {
  const data = {
    'code': 200,
    'msg': null,
    'data': {
...
// 选项卡分组数据查询
export function findAgentOrderGroups(param) {
  const data = {
    'code': 200,
    'msg': null,
    'data': {
...
// 代记账订单完成
export function finishAgentOrder(param) {
  return {
...
// 代记账订单关闭
export function closeAgentOrder(param) {
  return {
...
// 代记账订单删除
export function deleteAgentOrder(param) {
  return {
