<template>
  <div class="container">
    <el-card class="card">
      <div class="content">
        <div class="width: 850px; margin: 50px auto;">
        ...
        <div class="form">
          <el-form :model="activityForm" ref="activityForm" label-width="90px" size="medium">
            <template v-if="active == 1">
              <el-form-item label="活动类型" class="required" prop="activityMetaCode">
                <el-select v-model="activityForm.activityMetaCode" placeholder="请选择活动类型" style="width: 90%" @change="handleActivityMetaCodeChange(activityForm.activityMetaCode)">
              ...
              <el-form-item label="活动时间" class="required" prop="dateRangeType">
                <template>
                  <el-radio-group v-model="activityForm.dateRangeType">
            ...
            <template v-if="active == 2">
              ...
              <!-- 新人红包 -->
              <refresh-man-red-packet-rule ref="refreshManRedPacketRule" @before="before" @submit="submit" :parentForm="activityForm" :oper="oper" v-if="activityForm.activityMetaCode === 'REFRESHMAN_REDPACKET'"></refresh-man-red-packet-rule>
              <!-- 新人送券 -->
          ...
          <div v-if="active == 3" style="text-align: center;">
            <template v-if="result.success">
              ...
              <br><br>
              <div style="font-size: 25pt;">新建成功</div>
              <div>
            ...
            <template v-else>
              ...
              <br><br>
              <div style="font-size: 25pt;">新建失败</div>
