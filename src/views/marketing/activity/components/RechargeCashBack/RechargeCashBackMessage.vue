  ...
  <div>
    ...
    <el-row>
      <el-col :span="4">
        ...
        <span
          class="item-content"
        >{{ this.activityData.activityMetaCodeDisplay === undefined ? '' : this.activityData.activityMetaCodeDisplay }}</span>
      </el-col>
      <el-col :span="5">
    ...
    <br />
    <recharge-cash-back-chart></recharge-cash-back-chart>
  </div>
</template>

<script>
import RechargeCashBackChart from "./RechargeCashBackChart";
import { ActivityAdminService } from "@/service/marketing/activity/ActivityAdminService";
import * as formatter from "@/utils/formatter";

export default {
  name: "ActivityDataStatistics",
  components: {
    RechargeCashBackChart
  },
  data() {
    return {
