  ...
  <div>
    ...
    <el-row>
      <el-col :span="4">
        ...
        <span class="item-content">充值返券</span>
      </el-col>
      <el-col :span="5">
    ...
    <div class="Statistics">
      <div class="kid">
        <div class="border">
          <span class="mesTitle">总充值次数</span>
          <div
            class="mesContent"
            style="color: #F56C6C;"
          >{{ this.activityData.avgUserInMoney === undefined ? '--' : this.activityData.avgUserInMoney }}</div>
        </div>
      </div>
      <div class="kid">
        <div class="border">
          <span class="mesTitle">总参与用户</span>
          <div
            class="mesContent"
            style="color: #409eff;"
      ...
      <div class="kid">
        <div class="border">
          <span class="mesTitle">总充值金额</span>
          <div
            class="mesContent"
            style="color: #67C23A;"
      ...
      <div class="kid">
        <div class="border noRight">
          <span class="mesTitle">总返券金额</span>
          <div
            class="mesContent"
            style="color: #67C23A;"
    ...
    <recharge-coupon-back-chart></recharge-coupon-back-chart>
  </div>
</template>
...
import RechargeCouponBackChart from "./RechargeCouponBackChart";
export default {
  name: "RechargeCouponBackMessage",
  components: {
    RechargeCouponBackChart
  },
  data() {
    return {
