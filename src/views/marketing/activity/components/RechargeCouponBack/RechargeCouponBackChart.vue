<template>
  <div>
    ...
    <el-card style="margin-top: 12px;">
      ...
      <div class="noData" v-if="chartData2.rows == 0">暂无当前时间段数据</div>
    </el-card>
    <br />
  </div>
</template>
