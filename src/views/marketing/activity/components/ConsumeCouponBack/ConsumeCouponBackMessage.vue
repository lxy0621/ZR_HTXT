<template>
  <div>
    ...
    <consume-coupon-back-chart></consume-coupon-back-chart>
  </div>
</template>

<script>
import * as formatter from "@/utils/formatter";
import ConsumeCouponBackChart from "./ConsumeCouponBackChart";
import { ActivityAdminService } from "@/service/marketing/activity/ActivityAdminService";
export default {
  name: "ConsumeCouponBackMessage",
  components: {
    ConsumeCouponBackChart
  },
  data() {
    return {
