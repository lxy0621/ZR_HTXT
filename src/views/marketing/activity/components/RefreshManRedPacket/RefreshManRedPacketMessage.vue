  ...
  <div>
    ...
    <el-row>
      <el-col :span="4">
        ...
        <span class="item-content">新人红包</span>
      </el-col>
      <el-col :span="5">
    ...
    <div class="Statistics">
      ...
      <div class="kid">
        <div class="border">
          <span class="mesTitle">总发放红包金额</span>
          <div
            class="mesContent"
            style="color: #67C23A;"
    ...
    <new-people-packet-chart></new-people-packet-chart>
  </div>
</template>
...
import NewPeoplePacketChart from "./RefreshManRedPacketChart";
export default {
  name: "RefreshManRedPacketMessage",
  components: {
    NewPeoplePacketChart
  },
  data() {
    return {
