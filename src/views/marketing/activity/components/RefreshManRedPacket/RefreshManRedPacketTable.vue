<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="rpName" label="红包" align="center"></el-table-column>
...
export default {
  ...
  mounted() {
    ...
    if (this.$route.query !== undefined) {
      ...
      this.loadRefreshManRedPacketData(this.queryParams);
    }
  },
  methods: {
    initSelectData() {
    ...
    loadRefreshManRedPacketData(params) {
