<template>
  <div>
    <el-card>
      <month-search @search="searchMarketCollectRecordList" @reset="resetAllParamsAndData" ref="search_panel"/>
      <month-search-btn-groups @search="searchMarketCollectRecordList" ref="groups_panel"></month-search-btn-groups>
      ...
      <month-table ref='table_panel'></month-table>
    </el-card>
  </div>
</template>
