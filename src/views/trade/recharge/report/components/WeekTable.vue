<template>
  <div>
    ...
    <el-table :header-cell-style="{background:'#eef1f6',color:'#606266'}" :data="tableData" size="mini" border ref="multipleTable"
      ...
      <!-- <el-table-column prop="stationName" label="油站名称" align="center">
      </el-table-column> -->
      ...
      <el-table-column prop="totalNums" label="总订单数" min-width="100" align="center">
      </el-table-column>
      <el-table-column prop="dateNo" label="周数" align="center" min-width="120">
      </el-table-column>
      <el-table-column prop="dateNo" label="对应日期" align="center" min-width="160">
        <template slot-scope="scope">
          {{scope.row.rechargeDateStart.substring(0,10)}} ~ {{scope.row.rechargeDateEnd.substring(0,10)}}
        </template>
      </el-table-column>
    </el-table>
  ...
  export default {
    ...
    methods: {
      ...
      getDataList(params) {
        ...
        this.rechargeOrderService.pageWeekList(this.dataForm).then(response => {
