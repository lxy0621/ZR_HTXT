<template>
  <search-container @search="handleDataSearch" @reset="handleAllReset" can-fold>
    ...
    -->
    <search-container-item>
      <el-date-picker type="monthrange" v-model="queryParams.rechargeDate" value-format="yyyy-MM-dd" size="small" style="width: 100%"
        range-separator="至" start-placeholder="充值开始月" end-placeholder="充值结束月">
      </el-date-picker>
    </search-container-item>
  </search-container>
</template>
