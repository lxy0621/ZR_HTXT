<template>
  <div>
    ...
    <el-table :header-cell-style="{background:'#eef1f6',color:'#606266'}" :data="tableData" size="mini" border ref="multipleTable"
      ...
      <el-table-column prop="dateNo" label="年份" align="center" min-width="120">
      </el-table-column>
    </el-table>
  ...
  export default {
    ...
    methods: {
      ...
      getDataList(params) {
        ...
        this.rechargeOrderService.pageYearList(this.dataForm).then(response => {
