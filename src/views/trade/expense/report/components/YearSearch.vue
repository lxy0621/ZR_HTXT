<template>
  <search-container @search="handleDataSearch" @reset="handleAllReset" can-fold>
    ...
    <search-container-item style="min-width: 400px;">
      <el-row :gutter="5">
        <el-col :span="9">
    ...
    <search-container-item>
      <el-row>
        <el-col :span="11">
          <el-date-picker v-model="queryParams.expenseDateStart" type="year" value-format="yyyy-MM-dd" format="yyyy 年" placeholder="选择开始年" size="small" style="width: 100%"></el-date-picker>
        </el-col>
        <el-col class="line" :span="2" style="text-align: center;">至</el-col>
        <el-col :span="11">
          <el-date-picker v-model="queryParams.expenseDateEnd" type="year" value-format="yyyy-MM-dd" format="yyyy 年" placeholder="选择结束年" size="small" style="width: 100%"></el-date-picker>
        </el-col>
      </el-row>
    </search-container-item>
  </search-container>
