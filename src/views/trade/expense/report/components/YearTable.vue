...
export default {
    ...
    formatNumber(num) {
      return formatter.formatNumber(num);
		...
		getList(queryParams) {
			...
			this.service.pagingOrderYearReport(queryParams).then(response => {
    ...
    exportOrderYearReport(queryParams) {
			this.service.exportOrderYearReport(queryParams).then(response => {
