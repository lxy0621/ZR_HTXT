...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      this.findGroupOrderDayReport(this.queryParams);
    },
    methods: {
      formatNumber(num) {
        return formatter.formatNumber(num);
      },
      findGroupOrderDayReport(queryParams) {
        this.queryParams = queryParams;
        this.loading = true;
        this.service.findGroupOrderDayReport(queryParams).then(response => {
