...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      this.findGroupOrderWeekReport(this.queryParams);
    },
    methods: {
      formatNumber(num) {
        return formatter.formatNumber(num);
      },
      findGroupOrderWeekReport(queryParams) {
        this.queryParams = queryParams;
        this.loading = true;
        this.service.findGroupOrderWeekReport(queryParams).then(response => {
