...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      this.findGroupOrderMonthReport(this.queryParams);
    },
    methods: {
      formatNumber(num) {
        return formatter.formatNumber(num);
      },
      findGroupOrderMonthReport(queryParams) {
        this.queryParams = queryParams;
        this.loading = true;
        this.service.findGroupOrderMonthReport(queryParams).then(response => {
