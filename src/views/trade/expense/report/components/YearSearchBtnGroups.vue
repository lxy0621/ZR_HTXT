...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      this.findGroupOrderYearReport(this.queryParams);
    },
    methods: {
      formatNumber(num) {
        return formatter.formatNumber(num);
      },
      findGroupOrderYearReport(queryParams) {
        this.queryParams = queryParams;
        this.loading = true;
        this.service.findGroupOrderYearReport(queryParams).then(response => {
