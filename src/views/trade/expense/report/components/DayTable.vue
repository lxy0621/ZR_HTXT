  ...
  export default {
    ...
    methods: {
      ...
      getList(queryParams) {
        ...
        this.service.pagingOrderDayReport(queryParams).then(response => {
      ...
      exportOrderDayReport(queryParams) {
        this.service.exportOrderDayReport(queryParams).then(response => {
