...
<script>
  ...
  export default {
    name: "CashierOrderSearchBtnGroups",
    data() {
      return {
        loading: false,
        searchBtnShow: true,
    ...
    mounted() {
      this.service = new CashierOrderService();
      this.findCashierOrderGroups(this.queryParams);
    },
    methods: {
      toggleContainer(index) {
        this.active = index;
      },
      findCashierOrderGroups(queryParams) {
        this.loading = true;
        this.queryParams = queryParams;
        this.service.findCashierOrderGroups(queryParams).then(response => {
          // 查询结果
