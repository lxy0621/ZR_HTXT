<template>
  <search-container @search="handleDataSearch" @reset="handleAllReset" can-fold>
    <search-container-item>
      <el-input v-model="queryParams.unionQuery" placeholder="订单号/交易流水号" size="small"/>
    </search-container-item>
    <search-container-item>
    ...
    <search-container-item>
      <el-select v-model="queryParams.payState" placeholder="支付状态" size="small" style="width:100%;" multiple clearable>
        <el-option v-for="item in payState" :key="item.value" :label="item.key" :value="item.value"></el-option>
      </el-select>
    </search-container-item>
    <search-container-item>
      <el-select v-model="queryParams.refundState" placeholder="退款状态" size="small" style="width:100%;" multiple clearable>
        <el-option v-for="item in refundState" :key="item.value" :label="item.key" :value="item.value"></el-option>
      </el-select>
    </search-container-item>
