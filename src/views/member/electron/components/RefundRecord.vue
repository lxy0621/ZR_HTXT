<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="rechargeMoney" label="退款充值金额（元）" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column prop="giftMoney" label="退款赠送金额（元）" align="center">
        <template slot-scope="scope">
  ...
  export default {
    ...
    methods: {
      ...
      getList(queryParams) {
        ...
        this.memberService.pageRefundOrdersByMemberId(this.queryParams)
          .then(response => {
